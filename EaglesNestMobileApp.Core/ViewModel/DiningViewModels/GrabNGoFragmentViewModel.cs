...
{
    public class GrabNGoFragmentViewModel : ViewModelBase
    {
        /* All the items being served in Grab And Go        */
        private List<GrabAndGoItem> _grabAndGo;
        public GrabAndGoMenu GrabAndGoMenuItems
        {
            get { return _grabAndGoMenuItems; }
            set { Set(() => GrabAndGoMenuItems, ref _grabAndGoMenuItems, value); }
        }

        /* The Grab And Go menu to be used by the views     */
        private GrabAndGoMenu _grabAndGoMenuItems;
        public List<GrabAndGoItem> GrabAndGo
        {
            get { return _grabAndGo; }
            set { Set(() => GrabAndGo, ref _grabAndGo, value); }
        }
