...
namespace EaglesNestMobileApp.Core.ViewModel.AccountViewModels
{
    public class StudentInfoFragmentViewModel : ViewModelBase
    {
        ...
        {
            await Dialog.StartDialogAsync("Box Combination Instructions",
                "In order to open your box, turn the " +
        ...
        {
            await Dialog.StartDialogAsync("    Messaging and Telephone\n" +
                                          "               Instructions",
                "Each residence hall student is provided with a personal" +
