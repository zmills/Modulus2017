...
namespace EaglesNestMobileApp.Core.Services
{
    public static class Authenticator
    {
        ...
        /* This method creates a hash of a plain string password concatenated  */
        /* with a salt value                                                   */
        public static string HashPassword(string password, string salt)
        {
            /* Change the string encoding of the password and salt and append  */
            /* the salt to the password                                        */
