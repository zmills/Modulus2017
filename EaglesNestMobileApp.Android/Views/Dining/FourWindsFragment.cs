...
namespace EaglesNestMobileApp.Android.Views.Dining
{
    public class fourWindsFragment : Fragment
    {
        ...
        public NestedScrollView _nestedScrollView;

        public DiningFragmentsViewModel ViewModel
        {
            get { return App.Locator.Dining; }
        }
        ...
        private void TabLayoutSelected(object sender, TabLayout.TabSelectedEventArgs e)
        {
            ...
            _nestedScrollView.SmoothScrollTo(0, 0);
        }
        ...
        public void GetRecyclerViews()
        {
            ...
            _lineTwoRecyclerView =
                menuItemLayoutView.FindViewById<RecyclerView>(Resource.Id.Line2RecyclerView);
            _lineThreeRecyclerView =
                menuItemLayoutView.FindViewById<RecyclerView>(Resource.Id.Line3RecyclerView);
            _lineFourRecyclerView =
                menuItemLayoutView.FindViewById<RecyclerView>(Resource.Id.Line4RecyclerView);
            _lineFiveRecyclerView =
                menuItemLayoutView.FindViewById<RecyclerView>(Resource.Id.Line5RecyclerView);
            _lineSixRecyclerView =
                menuItemLayoutView.FindViewById<RecyclerView>(Resource.Id.Line6RecyclerView);
            _lineSevenRecyclerView =
                menuItemLayoutView.FindViewById<RecyclerView>(Resource.Id.Line7RecyclerView);
        }
